  ...
  return (
    <SlideContainer>
      <div className="space-y-8">
        ...
        >
          <p className="text-xs uppercase tracking-[0.2em] text-honey sm:text-sm">The Year in Vibes</p>
          <h2 className="mt-2 font-display text-2xl text-white sm:text-4xl lg:text-5xl">
